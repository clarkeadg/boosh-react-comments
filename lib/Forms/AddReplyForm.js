...
/* Components */
var AddReplyForm = function (_React$Component) {
  (0, _inherits3.default)(AddReplyForm, _React$Component);

  function AddReplyForm(props) {
    (0, _classCallCheck3.default)(this, AddReplyForm);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AddReplyForm.__proto__ || (0, _getPrototypeOf2.default)(AddReplyForm)).call(this, props));
  ...
  (0, _createClass3.default)(AddReplyForm, [{
    key: 'render',
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(AddReplyForm);